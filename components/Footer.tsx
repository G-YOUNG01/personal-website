      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-muted mt-1">AI 程序员 · 全栈开发 · 开源爱好者</p>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link href="/rss.xml" className="text-muted hover:text-foreground transition-colors" aria-label="RSS">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-6 border-t border-border text-center text-sm text-muted">
          © {year} G-YOUNG. Built with Next.js · Drizzle ORM · SQLite
        </div>
      </div>
    </footer>
  );
