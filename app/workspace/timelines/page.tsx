...
import AdminDeleteButton from "@/components/workspace/AdminDeleteButton";
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <Link href="/workspace/timelines/new" className="btn-primary text-sm">
          + 添加时间线
        </Link>
      </div>
              ...
              {rows.map((t) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-right whitespace-nowrap">
                    <Link
                      href={`/workspace/timelines/${t.id}/edit`}
